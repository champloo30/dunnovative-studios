  ...
  return (
    <button 
      className={`
        ...
        ${submit && 'sm:bg-brown xl:bg-toffee xl:hover:bg-brown dark:bg-oxford xl:dark:bg-aquamarine xl:dark:hover:bg-oxford border-none font-daughter text-whiteCrest xl:text-brown xl:hover:text-whiteCrest dark:text-aquamarine xl:dark:text-oxford xl:dark:hover:text-aquamarine text-xl'}
      `}
      onClick={onClick}
