  ...
  return (
    <button 
      className={`
        ...
        ${submit && 'hover:bg-brown dark:hover:bg-oxford border-none font-daughter text-brown hover:text-whiteCrest dark:text-oxford dark:hover:text-aquamarine text-xl'}
      `}
      onClick={onClick}
