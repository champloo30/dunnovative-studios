  ...
  return (
    <>
      {!test ? 
        ...
        <div className='md:h-96 lg:h-72 md:w-80 lg:w-[25rem] px-6 flex flex-col justify-center items-center md:gap-12 lg:gap-4 bg-whiteCrest dark:bg-oxford rounded-2xl text-brown dark:text-lightOxford'>
