...
const Guarantee = () => {
  return (
    <section aria-label='guarantee' id='guarantee' className='lg:h-[960px] xl:h-[640px] w-screen flex justify-center items-center'>
      <Container>
        <div className='h-full w-full flex flex-col justify-center items-center gap-16'>
          ...
          <ul className='flex justify-center items-center gap-8 lg:flex-wrap'>
