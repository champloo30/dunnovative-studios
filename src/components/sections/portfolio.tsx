...
const Portfolio = () => {
  return (
    <section aria-label='portfolio' id='portfolio' className='md:h-[720px] lg:h-[640px] w-screen flex justify-center items-center'>
      <Container>
        <div className='h-full w-full flex justify-between items-center'>
          ...
          {/* right */}
          <div className='h-full lg:w-2/3 flex md:flex-col lg:flex-row lg:justify-end items-center gap-8'>
